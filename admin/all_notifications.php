...
<div class="">
    ...
    // $featured_image = $row['featured_image'];
     $type = $row['type'];
     $seen_users = ""; //count(unserialize($row['seen_users'])); //sizeof($row['seen_users']);
      $id = $row['id'];
     ...
     ?>
      ...
      <tr>
        ...
        <td><?php echo substr($body, 0,30); ?></td>
        <!-- <td><?php //echo $referred_by; ?></td> -->
        <!--  <td><?php //echo $date; ?></td> -->
        
        <td><?php echo $seen_users; ?></td>
  ...
  <div class="dropdown-menu">
    <a class="dropdown-item" href="notification.php?e=<?php echo $id   ?>">Edit</a>
    ...
    <div class="modal-dialog modal-sm">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <p>You are about to delete this Notification</p>
        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
        </div>
        <div class="modal-footer">
            <a href="all_notifications.php?d=<?php echo $id ?>">
