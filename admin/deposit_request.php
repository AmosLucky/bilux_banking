...
<div class="container-fluid" >
    ...
    <tbody>
     ...
     $sql = "SELECT * from transactions  where status = 'pendding' || status = 'pending' and transaction_type = 'Deposit' order by id desc";
      $sn = 1;
    ...
    <div class="modal-dialog modal-sm">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <p>You are about to approve this deposit, Aproval Can't be reversed</p>
        </div>
