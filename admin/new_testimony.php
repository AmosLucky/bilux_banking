...
if (in_array($ext, $allowed)) {
  $location = "../uploads/".$filename;
   move_uploaded_file($_FILES['featured_image']['tmp_name'],$location);
   $sql = "UPDATE  testimonies set name = '$name',body = '$body',occupation ='$occupation',
                featured_image = '$filename' where id = '$id'
              ";

}else{
   $sql = "UPDATE  testimonies set name = '$name',body = '$body',occupation ='$occupation' where id = '$id'";
  ...
  <head>
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800"><b>NEW TESTIMONY</b></h1>
   ...
   <input type="text" name="name" class="form-control" placeholder="Name" value="<?php echo 
   $name ?>">
    ...
    <input type="text" required="" class="form-control" name="occupation" placeholder="Occupation" value="<?php echo 
   $occupation ?>">
