...
if(isset($_GET['d'])){
  ...
  $sql = "DELETE FROM why_choose_us where id = '$id'";
...
<div class="">
    ...
    <tbody> -->
       ...
       <div class=""><?php echo $msg ?></div>
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">All why_choose_us</h6>
     ...
     $sql = "SELECT * FROM why_choose_us order by id desc";
      $sn = 1;
  ...
  <div class="dropdown-menu">
    <a class="dropdown-item" href="new_why_choose_us.php?e=<?php echo $id   ?>">Edit</a>
  ...
  <div class="modal fade" id="myModal<?php  echo $id?>" role="dialog">
    <div class="modal-dialog modal-sm">
      <div class="modal-content">
        ...
        <div class="modal-footer">
            <a href="all_why_choose_us.php?d=<?php echo $id ?>">
