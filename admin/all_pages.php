...
<div class="">
  ...
  <div class="dropdown-menu">
    <a class="dropdown-item" href="new_page.php?e=<?php echo $id   ?>">Edit</a>
      ...
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <form method="POST">
            ...
            <input type="submit" name="" value="Confirm Delete Post">
            
          </form>
           <!--  <a href="all_pages.php?d=<?php //echo $id ?>">
