      ...
      $profit_percent = $row['profit'];
             $name = $row['name'];
              ...
              $new_profit = $amount *   $hundred_percent_profit_one_day;
               $new_profit = round($new_profit) / 288; ///////////5mins for 24hrs
               ///////////////////for adding profit//////////
                ...
                $total_capital_hours = $capital_after*24;
                 ...
                 $new_capital_running_hours  = (float)$capital_running_hours + 0.084;
                 $new_profit_running_hours  =  (float)$profit_running_hours + 0.084;
