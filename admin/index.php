...
<div class="container-fluid">
 ...
 if(isset($_POST['delete'])){ ?>
    ...
    <tbody> -->
     ...
     $sql = "SELECT * from members where deleted = '0' && is_suspended = '0' order by id desc";
      $sn = 1;
     ...
     ?>
      ...
      <tr>
        ...
        <td><?php echo round($ref_balance,3); ?></td>
  ...
  <div class="dropdown-menu">
    <a class="dropdown-item" href="user_details.php?v=<?php echo $id   ?>">Edit</a>
    <a class="dropdown-item" href="add_fund.php?v=<?php echo $id."&&n=".$username   ?>">Add Fund</a>
    <a class="dropdown-item" href="suspend.php?v=<?php echo $id."&&n=".$username  ?>">Suspend user</a>
    <a class="dropdown-item" href="deduct_account.php?v=<?php echo $id."&&n=".$username  ?>">Deduct Acount</a>
    <a class="dropdown-item" href="notification.php?u=<?php echo $id."&&n=".$username  ?>">Send Message</a>
     <a class="dropdown-item" href="block_reward.php?v=<?php echo $id."&&n=".$username  ?>">Add block reward</a>
  </div>
</div>
<!-- ///////////////////////////
 -->      </td>
