...
?>
            ...
            <article class="simple-page"> 
                <h1 class="simple-page__title">Privacy Policy</h1> 
                <div class="simple-page__partwrap"> 
                    <div class="simple-page__partwrap"> 
                        <h2 class="simple-page__posttitle">1. Definitions and Interpretation</h2> 
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <p class="mb-0 ps-3">
                    If you think anyone is violating any of these Terms, please <a href="mailto:<?php echo $company_email ?>"> notify us</a>.</p>
                  <hr class="my-4" />
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <hr class="my-4" />
                  <p class="fs-0 mb-0 fw-semi-bold">Force major</p>
